<footer id="contact" class="bg-navy text-white py-24"> 
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-8 text-sm"> 
            <div> 
                ...
                <ul class="space-y-1"> 
                    ...
                    <li><a href="{{ url('/#berita') }}" class="hover:underline">News</a></li>
                </ul> 
            </div> 
            <div>
                 <h4 class="font-semibold mb-2">Service</h4> 
                 <ul class="space-y-1"> 
                    <li><a href="#" class="hover:underline">Case Owner</a></li> 
                    <li><a href="#" class="hover:underline">Talent Researcher</a></li> 
                </ul>
            </div> 
            <div> 
