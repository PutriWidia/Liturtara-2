...
<body class="text-blue-900 bg-white">
        ...
        <nav class="flex-1 flex justify-center">
          <ul class="flex list-none gap-8">
            <li>
              <a
                href="#"
                class="no-underline text-blue-900 font-medium transition-colors duration-300 relative hover:text-green-500">Home</a>
            </li>
            <li>
              <a
                href="#"
                class="no-underline text-blue-900 font-medium transition-colors duration-300 relative hover:text-green-500">About Us</a>
            </li>
            <li class="relative group">
              <a
                href="#"
                class="no-underline text-blue-900 font-medium transition-colors duration-300 relative hover:text-green-500">Service <i class="fas fa-chevron-down"></i></a>
              <div
                class="hidden group-hover:block absolute bg-white min-w-[200px] shadow-lg rounded-lg p-4 top-full left-0 z-[1001]">
                <a
                  href="#"
                  class="block py-2 text-blue-900 no-underline transition-colors duration-300 hover:text-green-500">Case Owner</a>
                <a
                  href="#"
                  class="block py-2 text-blue-900 no-underline transition-colors duration-300 hover:text-green-500">Talent Researcher</a>
              </div>
            </li>
            <li>
              <a
                href="#"
                class="no-underline text-blue-900 font-medium transition-colors duration-300 relative hover:text-green-500">News</a>
            </li>
            <li>
              <a
                href="#"
                class="no-underline text-blue-900 font-medium transition-colors duration-300 relative hover:text-green-500">Our Contact</a>
            </li>
          </ul>
        </nav>
        <div class="flex items-center gap-6">
          <div class="flex items-center gap-1">
            <button
              ...
              <span class="text-sm text-blue-900 font-medium leading-none">0</span>
              <span
                class="text-sm text-blue-900 font-medium normal-case tracking-normal">Token</span>
            </button>
            <button
              class="bg-none border-none py-2 px-4 cursor-pointer rounded-full transition-all duration-300 flex items-center gap-1 relative text-blue-900 font-medium no-underline hover:bg-gray-100 hover:text-green-500"
              ...
              <span class="text-sm text-blue-900 font-medium leading-none">0</span>
              <span
                class="text-sm text-blue-900 font-medium normal-case tracking-normal">Poin</span>
            </button>
            <button
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div
          ...
          <div class="mb-6">
            ...
            <div class="flex flex-col gap-2">
              <span class="text-sm text-slate-500">12 completed projects</span>
        ...
        <div
          ...
          <div class="mb-6">
            ...
            <div class="flex flex-col gap-2">
              <span class="text-sm text-slate-500">15 completed projects</span>
              <div class="flex items-center gap-2">
                <span class="text-sm text-slate-500">Current Rating:</span>
                <div class="flex gap-0.5">
                  <i class="fas fa-star text-amber-400 text-sm"></i>
        ...
        <div
          ...
          <div class="mb-6">
            ...
            <div class="flex flex-col gap-2">
              <span class="text-sm text-slate-500">10 completed projects</span>
              <div class="flex items-center gap-2">
                <span class="text-sm text-slate-500">Current Rating:</span>
                <div class="flex gap-0.5">
                  <i class="fas fa-star text-amber-400 text-sm"></i>
        ...
        <div
          ...
          <div class="mb-6">
            ...
            <div class="flex flex-col gap-2">
              <span class="text-sm text-slate-500">11 completed projects</span>
              <div class="flex items-center gap-2">
                <span class="text-sm text-slate-500">Current Rating:</span>
                <div class="flex gap-0.5">
                  <i class="fas fa-star text-amber-400 text-sm"></i>
  ...
  <section class="relative pt-16 pb-0 overflow-hidden">
    <div
      class="cta-background absolute top-[100px] left-0 right-0 bottom-0 z-[1] bg-cover bg-center"></div>
          ...
          <div>
            ...
            <ul class="list-none">
              <li class="mb-2">
                <a
                  href="#"
                  class="text-slate-300 no-underline transition-colors duration-300 hover:text-green-500">Home</a>
              </li>
              <li class="mb-2">
                <a
                  href="#"
                  class="text-slate-300 no-underline transition-colors duration-300 hover:text-green-500">About</a>
              </li>
              <li class="mb-2">
                <a
                  href="#"
                  class="text-slate-300 no-underline transition-colors duration-300 hover:text-green-500">News</a>
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul class="list-none">
              <li class="mb-2">
                <a
                  href="#"
                  class="text-slate-300 no-underline transition-colors duration-300 hover:text-green-500">Case Owner</a>
              </li>
              <li class="mb-2">
                <a
                  href="#"
                  class="text-slate-300 no-underline transition-colors duration-300 hover:text-green-500">Talent Researcher</a>
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul class="list-none">
              <li class="mb-2">
                <a
                  href="#"
                  class="text-slate-300 no-underline transition-colors duration-300 hover:text-green-500">Contact Us</a>
              </li>
              <li class="mb-2">
                <a
                  href="#"
                  class="text-slate-300 no-underline transition-colors duration-300 hover:text-green-500">FAQ</a>
              </li>
              <li class="mb-2">
                <a
                  href="#"
                  class="text-slate-300 no-underline transition-colors duration-300 hover:text-green-500">Terms and Conditions</a>
              </li>
              <li class="mb-2">
                <a
                  href="#"
                  class="text-slate-300 no-underline transition-colors duration-300 hover:text-green-500">Privacy Policy</a>
              </li>
            </ul>
          </div>
        </div>
