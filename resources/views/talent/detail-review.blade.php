...
@section('title', 'Detail Case Review')
@section('content')
...
<div class="lg:col-span-4">
    <div class="relative bg-white rounded-2xl shadow-[0_20px_40px_rgba(11,31,91,0.12)] min-h-[550px] flex flex-col items-center">
        <span class="absolute top-0 right-0 bg-blue-700 text-white text-sm px-8 py-3 rounded-bl-2xl rounded-tr-2xl font-medium">
            Review
        </span>
...
<!-- Logo + Title -->
<div class="flex items-center gap-2 mt-8 mb-6 w-full justify-center px-6 py-8 sm:justify-start sm:px-10 sm:py-12 lg:pl-20 lg:py-20">
    <img src="logo.png"
    alt="Logo"
...
<div
  class="mt-10 bg-white rounded-2xl shadow-md border border-gray-100 
         flex items-center justify-between px-6 py-4 gap-6 max-w-[700px]"
>
  <!-- LEFT -->
  <div class="flex items-start gap-4">
    ...
    <div
      class="w-10 h-10 flex items-center justify-center
             rounded-lg border-2 border-[#0B1F5B] text-[#0B1F5B]"
    >
      <svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="2"
           viewBox="0 0 24 24">
        <path d="M9 2H5a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V8l-6-6H9z"/>
        <path d="M9 2v6h6"/>
      </svg>
    </div>
...
<button
  onclick="openModal()"
  class="bg-[#0B1F5B] text-white font-semibold px-6 py-2
         rounded-xl shadow hover:opacity-90 transition flex items-center gap-2"
>
  Review
  <span>→</span>
</button>
...
<!-- OVERLAY -->
<div id="modalOverlay" class="fixed inset-0 bg-black/40 z-40 hidden"></div>

<!-- MODAL WRAPPER -->
<div id="certificateModal"
     class="fixed inset-0 z-50 flex items-center justify-center px-6 hidden">

  <!-- MODAL BOX -->
<div class="relative bg-white w-full max-w-3xl h-[85vh] rounded-2xl shadow-xl overflow-hidden">

    <!-- CLOSE BUTTON -->
    <button
      onclick="closeModal()"
      class="absolute top-5 right-5 text-[#0C295F] text-2xl font-bold z-10">
      ✕
    </button>

    <!-- SCROLL AREA -->
<div class="h-full overflow-y-auto px-14 py-16">

  <!-- HEADLINE -->
  <h1 class="text-3xl font-semibold text-center text-gray-800 mb-20">
    Headline
  </h1>
  ...
  <!-- DATE -->
  <p class="text-xs text-gray-400 text-center mt-20">
    20 Oktober 2024
  </p>
