...
@include('layout.navbar')
    ...
    <div class="lg:col-span-4">
        <div class="relative bg-white rounded-2xl shadow-[0_20px_40px_rgba(11,31,91,0.12)] min-h-[550px] flex flex-col items-center">
            <span class="absolute top-0 right-0 bg-yellow-400 text-white text-sm px-8 py-3 rounded-bl-2xl rounded-tr-2xl font-medium">
                In Progress
            </span>
        ...
        <!-- Logo + Title -->
        <div
        class="flex items-center gap-2 mt-8 mb-6 w-full justify-center px-6 py-8 sm:justify-start sm:px-10 sm:py-12 lg:pl-20 lg:py-20">
...
<div class="mt-10 flex justify-end">
  <button
    class="flex items-center gap-2 bg-[#0B1F5B] text-white font-semibold
           px-6 py-3 rounded-xl shadow hover:opacity-90 transition"
  >
    Send
    <span>→</span>
  </button>
