      ...
      <div class="flex justify-between items-start">
        ...
        <div class="flex flex-col items-end gap-3 -mt-5">
          ...
          <div class="flex items-center gap-4">
            ...
            <div class="flex items-center gap-1 text-yellow-400">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 .587l3.668 7.431L23.4 9.748l-5.7 5.556L19.335 24 12 19.897 4.665 24l1.633-8.696L.6 9.748l7.732-1.73L12 .587z" />
              </svg>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 .587l3.668 7.431L23.4 9.748l-5.7 5.556L19.335 24 12 19.897 4.665 24l1.633-8.696L.6 9.748l7.732-1.73L12 .587z" />
              </svg>
              ...
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#CBD5E1" stroke-width="1.5">
                <path d="M12 .587l3.668 7.431L23.4 9.748l-5.7 5.556L19.335 24 12 19.897 4.665 24l1.633-8.696L.6 9.748l7.732-1.73L12 .587z" />
              </svg>
            </div>
          ...
          <div class="flex items-center gap-3 relative">
            ...
            <!-- Jadikan tanggal sebagai GROUP -->
            <div class="relative group inline-block">
              <div class="text-xs bg-red-100 text-red-600 px-3 py-2 rounded-full font-semibold cursor-pointer">
                15 Des 2024
              </div>

              <!-- Tooltip (aktif hanya saat hover tanggal) -->
              <div class="absolute top-8 left-1 bg-red-600 text-white text-xs px-3 py-2 rounded-md 
            whitespace-nowrap
            opacity-0 group-hover:opacity-100 transition duration-300 pointer-events-none shadow-lg">
                Tanggal batas akhir item ini valid.
              </div>

            </div>

            <button class="text-red-500 border border-red-300 rounded-md px-4 py-2 text-sm font-semibold hover:bg-red-50">
              Report
            </button>

            <button class="bg-[#0C295F] text-white rounded-md px-4 py-2 text-sm font-semibold hover:bg-[#0b2243]"><a href="{{ route('talent.detail') }}">Detail</a>
            </button>
      ...
      <div class="flex justify-between items-start">
        ...
        <div class="flex flex-col items-end gap-3 -mt-5">
          ...
          <div class="flex items-center gap-3 relative">
            ...
            <button class="bg-[#0C295F] text-white rounded-md px-4 py-2 text-sm font-semibold hover:bg-[#0b2243]"><a href=""></a>
              Detail
            </button>
      ...
      <div class="flex justify-between items-start">
        ...
        <div class="flex flex-col items-end gap-3 -mt-5">
          ...
          <div class="flex items-center gap-3 relative">
            ...
            <button class="bg-[#0C295F] text-white rounded-md px-4 py-2 text-sm font-semibold hover:bg-[#0b2243]">
              Detail
            </button>
