...
@section('title', 'Solution In Progress')
@section('content')
...
<div class="fixed top-0 right-0 h-full w-full md:w-[45%] bg-white shadow-2xl z-50 overflow-y-auto p-10">
  ...
  <div class="absolute top-0 right-0 bg-yellow-400 text-black text-sm font-bold px-5 py-2 
        rounded-bl-2xl rounded-tr-2xl">
    In Progress
  </div>
...
<!-- Right action box -->
  <div class="border border-gray-200 rounded-xl p-6 shadow-md bg-white">
    <button class="w-full bg-[#0C295F] text-white py-2 rounded-lg mb-3">
      Send
    </button>
