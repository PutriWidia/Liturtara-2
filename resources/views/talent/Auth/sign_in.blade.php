        ...
        <div class="flex flex-col md:flex-row items-center">
            ...
            <div class="w-full md:w-1/2 mt-8 md:mt-0">
                <div class="max-w-md mx-auto bg-white p-8 rounded-lg shadow-lg">
                    ...
                    <h2 class="text-2xl font-bold text-navy mb-6">Log in Talent</h2>

                    <form action="{{ route('talent.login.post') }}" method="POST">
                        @csrf
                        <div class="mb-4">
                    ...
                    <div class="mt-6 text-center">
                        <p class="text-gray-700">
                            New to Liturtara?
                            <a href="{{ route('talent.register') }}" class="text-navy font-medium hover:underline">Sign up</a>
                        </p>
                    </div>
                </div>
            </div>
