 ...
 <section class="max-w-7xl mx-auto px-8 py-10 flex flex-col md:flex-row gap-8">
  ...
  <div class="w-full md:w-3/4 grid grid-cols-1 md:grid-cols-2 gap-8">
    ...
    <div class="bg-white rounded-2xl shadow-md hover:shadow-lg p-6 transition transform hover:-translate-y-1 border border-gray-100 relative">
      <span class="absolute top-0 right-0 bg-blue-900 text-white text-sm px-3 py-2 rounded-bl-lg rounded-tr-lg">Available</span>
      ...
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-2">
          <button class="border border-red-500 hover:border-white text-red-500 hover:text-white px-4 py-1.5 rounded-lg hover:bg-red-500 transition">Delete ✕</button>
...
<!-- PAGINATION -->
  ...
  <!-- Tombol Navigasi (tetap di tengah) -->
  <div class="flex items-center justify-center gap-2">
    <button class="flex items-center justify-center w-10 h-10 border border-gray-300 rounded-lg hover:bg-gray-500 transition">
      <span class="text-gray-700 hover:text-white text-lg">←</span>
    </button>

    <button class="flex items-center justify-center gap-2 px-3 py-1.5 text-white bg-blue-900 rounded-lg hover:bg-blue-800 transition">
      <span>Next</span>
...
<div class="fixed inset-0 bg-black/50 flex items-center justify-center z-50">
  <div class="bg-white w-3/4 md:w-2/3 lg:w-1/2 rounded-lg shadow-2xl p-10">
    
    <h2 class="text-2xl font-semibold text-blue-900 mb-6">
      <span class="text-3xl font-bold text-blue-900">XXXX</span>
      <span class="text-blue-900">– Your point currently</span>
    </h2>

    <div>
      <h3 class="text-xl font-semibold text-gray-800 mb-4">How to get points</h3>
      <ol class="list-decimal list-inside text-gray-700 space-y-2">
        <li>Upload your problem case</li>
        <li>Complete weekly activities</li>
