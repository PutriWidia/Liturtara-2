        ...
        <div class="grid grid-cols-1 lg:grid-cols-[320px_1fr] gap-8 lg:gap-20">
            ...
            <div class="w-full lg:pr-6">
                ...
                <div class="flex gap-6">
                    ...
                    <!-- Draft Card -->
                    <div class="bg-white shadow-md rounded-xl p-4 w-80 mb-6 relative">
                        <div class="flex items-center justify-center mt-9 gap-4">
                            ...
                            <!-- TEKS -->
                            <p class="font-semibold text-black text-2xl">
                                Draft Solusi
                            </p>
                        ...
                        <!-- LINK -->
                        <div class="flex justify-end">
                            <button class="text-blue-900 text-sm mt-5 font-semibold hover:underline">
                                View All Solution
                            </button>
                        </div>
                    </div>
